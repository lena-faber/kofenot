...
const sections = [
  {
    ...
    body: [
      ...
      "On Friday night she bought a new car, moved to Silicon Valley, posed " +
        "ambitious The Here™ to first launch not so ambitious KOFENOT, inspired " +
        "by an upside down coffee cup, which she always placed under her new " +
    ...
    image: {
      src: coffeeShop,
      alt:
        "KOFENOT in a coffee shop setting where laptops and coffee share " +
        "the same table",
    },
  },
  {
  ...
  },
  {
    ...
    body: [
      "This day came soon. One engineer saw Lena’s struggling to beautify " +
        "a piece of plastic, realized she had absolutely no idea how to prepare " +
        "files for injection molding and offered help.",
      "Lena raised the bar: the thing had to make a satisfyingly loud snap " +
        "when it closed.",
      "Not just close. Snap.",
      ...
      "She didn't know yet that the person patiently helping her was one of " +
        "the Valley's most senior industrial engineer in charge of designing " +
        "flying-cars…",
      "Done. People stare at KOFENOT™ as if it were a Rubik's Cube, turn it " +
        "around in their hands, open and close it a few times, and then ask " +
        "the same question: \"How does this thing work?” Including engineers.",
  ...
  },
  {
    ...
    body: [
      ...
      "More obstacle later, and during a regular phone call from a friend she'd " +
        "known since hiking the Appalachian Trail realized she still needed more money.",
      ...
      "A friend storing her inventory at his garage. A friend storing more inventory " +
        "in his office.",
      "KOFENOT™ may have one inventor. But it has many fingerprints.",
      "It feels like something an entire Silicon Valley neighborhood quietly decided " +
        "should exist.",
    ],
  },
];
...
const productCopy = [
  ...
  "What makes KOFENOT™ unusual is that it was not created by a consumer products " +
    "company. It was created by a startup founder building a much larger technology " +
    "venture.",
  "KOFENOT™ is a 1 oz, flat-folding laptop wedge that lifts a laptop at the hinge " +
    "to improve posture while helping deflect spills away from the keyboard. It also " +
    "serves as a stand for phones and tablets and features a front-facing area for " +
    "custom branding, making it suitable for corporate gifts, conferences, trade shows, " +
...
function StoryImage({ image }: { image?: { src: string; alt: string } }) {
  ...
  return (
    <figure
      className={
        "h-[58svh] min-h-[380px] overflow-hidden border-y " +
        "border-[rgba(0,255,0,0.18)] bg-black"
      }
    >
...
function ProductSection() {
  return (
    <section className="border-y border-[rgba(0,255,0,0.18)] bg-[rgba(0,255,0,0.025)]">
      <div
        className={
          "mx-auto grid max-w-[1320px] gap-8 px-4 py-20 " +
          "lg:grid-cols-[0.9fr_1.1fr] lg:px-6"
        }
      >
        <div>
          <h2 className="mt-3 text-5xl font-black tracking-tight md:text-6xl">
