...
const siteTitle = "KOFENOT™ | Custom Logo Laptop Wedge for Corporate Gifts & IT Teams";
const siteDescription = "KOFENOT™ is a pocket-flat laptop wedge for promo agencies, IT teams, corporate gifts, events, coffee shops, coworking spaces, wholesale resale, and custom logo programs. 1 oz. No magnets. No adhesives.";
...
const productJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      weight: "1 oz",
      audience: [
        { "@type": "BusinessAudience", audienceType: "Promotional product agencies" },
        { "@type": "BusinessAudience", audienceType: "IT teams" },
        { "@type": "BusinessAudience", audienceType: "Corporate gifting buyers" },
        { "@type": "BusinessAudience", audienceType: "Coffee shops and coworking spaces" },
      ],
      offers: {
        "@type": "Offer",
        price: "15.00",
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "KOFENOT custom logo laptop wedge for promo agencies, IT teams, and corporate gifts" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: siteTitle },
      { name: "twitter:description", content: siteDescription },
      { name: "twitter:image", content: siteImage },
      { name: "twitter:image:alt", content: "KOFENOT custom logo laptop wedge for promo agencies, IT teams, and corporate gifts" },
    ],
    links: [
      ...
      { rel: "alternate", type: "text/plain", title: "KOFENOT AI agent summary", href: "/llms.txt" },
