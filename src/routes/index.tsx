...
>
  ...
  className="group ml-7 mt-1 inline-flex h-12 w-fit items-center gap-4 rounded-xl bg-red-600 pl-3 pr-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-[0_0_34px_rgba(220,38,38,0.55)] transition hover:bg-red-500"
>
